...
public class Equipamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Equipamento", "Data", "Hora Entrada", "Hora Saida"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 240));
        ...
        getContentPane().add(da, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 150, -1));

        equipa.setText("jLabel1");
        getContentPane().add(equipa, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, -1, -1));

        pack();
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents
 
      public void recebendo(String recebe,String equipam){        
        da.setText(recebe);
        equipa.setText(equipam);
        comando();
     }
    ...
    public void comando (){
        ...
        PreparedStatement stmt=con.prepareStatement(sql);
           ...
           String dia =da.getText().substring(0,2);
            ...
            stmt.setObject(1,my);
            stmt.setString(2,equipa.getText());
        ...
        ResultSet rs = stmt.executeQuery();
            ...
            while (rs.next()){
                modelo.addRow(new Object[]{
                      rs.getString("batman"),rs.getString("EQUIPAMENTO"),rs.getString("DATAINICIO"),rs.getString("HORAINICIO"),rs.getString("HORAFIM"),rs.getString("EQUIPAMENTO"),rs.getString("SALAREUNIAO"),rs.getString("ASSUNTO")});
            }
            rs.close();
            con.close();
